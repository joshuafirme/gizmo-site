...
<ul class="sidebar-nav">
        ...
        <!-- Products Dropdown -->
        <li>
            <a href="#productsSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="d-flex align-items-center justify-content-between dropdown-toggle-custom">
            ...
            <ul class="collapse list-unstyled submenu-list" id="productsSubmenu">
                <li><a href="{{ route('admin.products.index') }}"><i class="fa-solid fa-list-ul"></i> Product List</a></li>
                <li><a href="{{ route('admin.categories.index') }}"><i class="fa-solid fa-tags"></i> Categories</a></li>
                <li><a href="{{ route('admin.subcategories.index') }}"><i class="fa-solid fa-tag"></i> Subcategories</a></li>
            </ul>
        </li>

        <!-- Page Sections Dropdown -->
        <li>
            <a href="#sectionsSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="d-flex align-items-center justify-content-between dropdown-toggle-custom">
                <span><i class="fa-solid fa-layer-group"></i> Page Sections</span>
                <i class="fa-solid fa-chevron-down toggle-icon" style="width: auto; font-size: 0.8em;"></i>
            </a>
            <ul class="collapse list-unstyled submenu-list" id="sectionsSubmenu">
                <li><a href="{{ route('admin.who-we-are.index') }}"><i class="fa-solid fa-users-gear"></i> Who We Are</a></li>
                <li><a href="{{ route('admin.about-us.index') }}"><i class="fa-solid fa-circle-info"></i> About Us</a></li>
                <li><a href="{{ route('admin.client-reviews.index') }}"><i class="fa-solid fa-star"></i> Client Reviews</a></li>
            </ul>
        </li>
        
        <!-- Administration Dropdown -->
        <li>
            <a href="#adminSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="d-flex align-items-center justify-content-between dropdown-toggle-custom">
        ...
        <li class="mt-4">
            <a href="#" class="text-danger"><i class="fa-solid fa-power-off text-danger"></i> Logout</a>
        </li>
    </ul>
</nav>
